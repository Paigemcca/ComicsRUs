...
// ********************************************************************************
// NOTE: THIS CODE HAS BEEN PROVIDED BY INSTRUCTOR FOR ACCESS TO MARVEL API
//        SOURCED FROM PHL[6] TEAM[1]
// ********************************************************************************
...
@CrossOrigin(origins = "*")
@Component
public class MarvelComicService implements com.techelevator.dao.MarvelComicService {

    private RestTemplate restTemplate = new RestTemplate();

    String Api_Base_URL = "http://gateway.marvel.com/v1/public";
    String timestamp = String.valueOf(Math.floor(Math.random()));
    String privateKey = "4dc94dd1ad81faacefa54995a4e2697db888520e";
    String publicKey = "adc9d216a363a3e61869d325cae4f329";
...
//    }
    ...
    //retrieves the id the API associates the comic with
    public int getComicIdByTitle (String comicTitle) {
        String comicJsonString = null;
        int comicId = 0;

        try {
            String exchangePath = Api_Base_URL + "/title?titleStartsWith=" + comicTitle + "&" + authInfoToString();
            ResponseEntity<String> response =
                    restTemplate.exchange(exchangePath, HttpMethod.GET, makeHeaders(), String.class);
        ...
        comicId = Integer.valueOf(findCharacterOrCreatorId("\"id\"", comicJsonString, 1));
